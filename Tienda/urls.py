...
from .views import Agregar_F, Listar_fundaciones, Listar_prod, detalle_productos, home,Contacto,QuienesSomos,Donaciones,Tiendas,\
...
urlpatterns = [
    ...
    path('modificar_fundacion/<id>',Listar_fundaciones, name="modificar_fundacion")
